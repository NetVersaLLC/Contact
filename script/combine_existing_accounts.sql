...
insert into client_data(business_id, created_at, updated_at, secrets, force_update, username, do_not_sync, profile_category_id, type) select business_id, created_at, updated_at, secrets, force_update, username, do_not_sync, ebusinesspage_category_id, "Ebusinesspage" from ebusinesspages;
insert into client_data(business_id, created_at, updated_at, secrets, force_update, profile_category_id, type) select business_id, created_at, updated_at, secrets, force_update, expertfocus_category_id, "Expertfocus" from expertfocus;
