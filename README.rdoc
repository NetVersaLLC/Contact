...
This repository contains git submodules ([more info on submodules here](http://git-scm.com/book/en/Git-Tools-Submodules)). Therefore, after you ````git clone````, you'll need to  ````init````  and  ````update````  the git submodule. For example,  

    git clone git@github.com:jjeffus/Contact.git
    git submodule init
    git submodule update
    # the Contacts/sites folder should now look like, https://github.com/netversa/sites
