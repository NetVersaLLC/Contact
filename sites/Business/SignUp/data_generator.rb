...
data[ 'email' ]             = 'netversatest65@yahoo.com' #business.yahoos.first.email
...
data[ 'password' ]	    = "Doomsdaydevice1!" #business.yahoos.first.password
time = Time.new
data[ 'years_in_business' ] = 12 #time.year - business.year_founded
