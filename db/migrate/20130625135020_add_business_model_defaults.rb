class AddBusinessModelDefaults < ActiveRecord::Migration
  def up
      ...
      change_column_default( :businesses,    :monday_open,  '08:30AM')
      change_column_default( :businesses,    :monday_close,  '05:30PM')
      change_column_default( :businesses,    :tuesday_open,  '08:30AM')
      change_column_default( :businesses,    :tuesday_close,  '05:30PM')
      change_column_default( :businesses,    :wednesday_open,  '08:30AM')
      change_column_default( :businesses,    :wednesday_close,  '05:30PM')
      change_column_default( :businesses,    :thursday_open,  '08:30AM')
      change_column_default( :businesses,    :thursday_close,  '05:30PM')
      change_column_default( :businesses,    :friday_open,  '08:30AM')
      change_column_default( :businesses,    :friday_close,  '05:30PM')
